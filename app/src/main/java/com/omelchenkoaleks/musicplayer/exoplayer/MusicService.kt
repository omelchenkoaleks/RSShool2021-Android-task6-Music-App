...
import com.omelchenkoaleks.musicplayer.data.MusicCatalog
import com.omelchenkoaleks.musicplayer.data.model.Track
import com.omelchenkoaleks.musicplayer.ui.MainActivity
import com.omelchenkoaleks.musicplayer.utils.Constants.AUDIO_FOCUSED
import com.omelchenkoaleks.musicplayer.utils.Constants.AUDIO_NO_FOCUS_CAN_DUCK
import com.omelchenkoaleks.musicplayer.utils.Constants.AUDIO_NO_FOCUS_NO_DUCK
import com.omelchenkoaleks.musicplayer.utils.Constants.CACHE_SIZE
import com.omelchenkoaleks.musicplayer.utils.Constants.NOTIFICATION_CHANNEL_ID
import com.omelchenkoaleks.musicplayer.utils.Constants.NOTIFICATION_ID
import com.omelchenkoaleks.musicplayer.utils.Constants.VOLUME_DUCK
import com.omelchenkoaleks.musicplayer.utils.Constants.VOLUME_NORMAL
import java.io.File

class MusicService : MediaBrowserServiceCompat() {

    private val metadataBuilder = MediaMetadataCompat.Builder()
    private var _catalog: MusicCatalog? = null
    private val musicCatalog: MusicCatalog by lazy { getMusicCatalog() }
    ...
    @JvmName("getMusicCatalog1")
    private fun getMusicCatalog() : MusicCatalog {
        return if (_catalog == null) {
            val catalog = MusicCatalog(this.applicationContext)
            _catalog = catalog
            catalog
        } else {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val audioAtr = AudioAttributes.Builder()
                ...
                if (!audioFocusRequested) {
                    ...
                    val audioFocusResult = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        audioManager?.requestAudioFocus(
                            this@MusicService.audioFocusChangeListener,
    ...
    private fun getNotification(playbackState: Int): Notification {
        ...
        builder.setSmallIcon(com.omelchenkoaleks.musicplayer.R.mipmap.ic_launcher)
