package com.omelchenkoaleks.musicplayer.ui
...
import com.omelchenkoaleks.musicplayer.utils.Constants.BUTTON_PAUSE
import com.omelchenkoaleks.musicplayer.utils.Constants.BUTTON_PLAY
import com.omelchenkoaleks.musicplayer.utils.Constants.BUTTON_PREVIOUS
import com.omelchenkoaleks.musicplayer.utils.Constants.BUTTON_STOP
import kotlinx.android.synthetic.main.activity_main.*

class MainActivity : AppCompatActivity() {
    private var mediaServiceBinder: MusicService.MediaServiceBinder? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        serviceConnection = object : ServiceConnection {
            ...
            override fun onServiceConnected(className: ComponentName?, service: IBinder?) {
                mediaServiceBinder = service as MusicService.MediaServiceBinder
                try {
